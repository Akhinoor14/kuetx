        ...
        <div style={{ flex: 1 }}>
          ...
          <Routes>
            ...
            {/* Phase 5 (SERVICE_BOOKING_REDESIGN_PLAN_PROMPT.md, Part B):
                ...
                specificity-based matching resolves it correctly,
                mirroring the same reasoning already documented above
                for /services/orders. */}
            <Route path="/services/:serviceId/about" element={<ServiceAbout />} />
