  ...
  return (
    <>
      <div onClick={() => setOpen(true)} style={{
        ...
        padding: '14px 18px', borderRadius: 14, marginBottom: '1.5rem',
        background: 'color-mix(in srgb, var(--accent) 7%, var(--surface))',
        border: '1.5px solid color-mix(in srgb, var(--accent) 28%, var(--border))',
        cursor: 'pointer', transition: 'background 0.15s',
      }}
        onMouseEnter={e => e.currentTarget.style.background = 'color-mix(in srgb, var(--accent) 13%, var(--surface))'}
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--text)', marginBottom: 2 }}>KUETx Guide — PDF</div>
      ...
      {open && (
        <>
          <div style={{ position: 'fixed', inset: 0, zIndex: 4999, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(6px)' }} onClick={() => setOpen(false)} />
          <div style={{ position: 'fixed', inset: 0, zIndex: 5000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, pointerEvents: 'none' }}>
            <div onClick={e => e.stopPropagation()} style={{ pointerEvents: 'auto', width: '100%', maxWidth: 500, maxHeight: 'calc(100dvh - 40px)', background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 18, boxShadow: '0 32px 80px rgba(0,0,0,0.28)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 18px', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
                ...
                <button onClick={() => setOpen(false)} style={{ background: 'transparent', border: 'none', cursor: 'pointer', color: 'var(--muted)', padding: 6, borderRadius: 8, display: 'flex', alignItems: 'center' }}>
                  <Icons.X size={17} />
                </button>
              </div>
              ...
              <div style={{ padding: '12px 18px', borderTop: '1px solid var(--border)', flexShrink: 0, background: 'var(--bg)' }}>
                <button onClick={() => setOpen(false)} className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', fontSize: 13 }}>Close Guide</button>
              </div>
            </div>
          </div>
        </>
