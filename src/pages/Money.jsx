...
export default function Money() {
  ...
  return (
    <div className="page-enter page-container">
      ...
      {/* Modal overlay */}
      {modal && (
        <div onClick={() => setModal(null)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.45)', zIndex: 4000, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
          <div onClick={e => e.stopPropagation()} style={{ background: 'var(--card, #fff)', width: '100%', maxWidth: 520, borderRadius: '20px 20px 0 0', paddingBottom: 'calc(20px + env(safe-area-inset-bottom, 0px))' }}>
