...
// to exist now (so the Role Select checkbox popup and the hamburger
// menu's "See our privacy policy →" link — see Navbar.jsx — both have
// somewhere real to point to instead of a dead /privacy route), with the
// actual KUETx-specific Privacy Policy + Terms & Conditions text to be
// dropped in and organized once he provides it. Nothing below should be
// treated as final legal copy — swap the section bodies, not the page
// structure, when the real content arrives.
//
