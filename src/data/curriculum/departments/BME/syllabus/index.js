...
import { BME_SYLLABUS_OPTIONAL } from './optional.js';
...
export const BME_SYLLABUS = {
  sourceFile: '',
  terms: TERM_SYLLABUS,
  optional: BME_SYLLABUS_OPTIONAL,
  courses: { ...mergeCourses(BME_SYLLABUS_Y1T1, BME_SYLLABUS_Y1T2, BME_SYLLABUS_Y2T1, BME_SYLLABUS_Y2T2, BME_SYLLABUS_Y3T1, BME_SYLLABUS_Y3T2, BME_SYLLABUS_Y4T1, BME_SYLLABUS_Y4T2), ...BME_SYLLABUS_OPTIONAL.courses },
};
