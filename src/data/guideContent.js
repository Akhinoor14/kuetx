...
const RAW_SECTIONS = [
...

  {
    ...
    descBn: "একটি নির্দিষ্ট class assignment-এর Active Students, Syllabus আর Schedule ট্যাব দেখুন।",
    descEn: "Open one class assignment to see the Active Students, Syllabus, and Schedule tabs.",
    blocksBn: [
      ...
      { type: 'bullet', text: 'Active Students, Syllabus, এবং Schedule ট্যাব live আছে' },
    ...
    blocksEn: [
      ...
      { type: 'bullet', text: 'Active Students, Syllabus, and Schedule are live tabs' },
